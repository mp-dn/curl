...
ACLOCAL = ${SHELL} '/home/dionach/mp-dn/curl/missing' aclocal-1.16
AMTAR = $${TAR-tar}
...
LDFLAGS = -L/home/dionach/mp-dn/openssl -L/home/dionach/mp-dn/openssl/lib
LIBCURL_LIBS = -lssl -lcrypto -lbrotlidec -lz
LIBCURL_NO_SHARED = 
LIBOBJS = 
LIBS = -lssl -lcrypto -lbrotlidec -lz
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/dionach/mp-dn/curl/missing' makeinfo
MANIFEST_TOOL = :
...
SSL_LIBS = 
STRIP = strip
SUPPORT_FEATURES = AsynchDNS HSTS HTTPS-proxy IPv6 Largefile NTLM SSL TLS-SRP UnixSockets alt-svc brotli libz threadsafe
SUPPORT_PROTOCOLS = DICT FILE FTP FTPS GOPHER GOPHERS HTTP HTTPS IMAP IMAPS IPFS IPNS MQTT POP3 POP3S RTSP SMB SMBS SMTP SMTPS TELNET TFTP
...
ZLIB_LIBS = -lz 
ZSH_FUNCTIONS_DIR = 
abs_builddir = /home/dionach/mp-dn/curl
abs_srcdir = /home/dionach/mp-dn/curl
abs_top_builddir = /home/dionach/mp-dn/curl
abs_top_srcdir = /home/dionach/mp-dn/curl
ac_ct_AR = 
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/dionach/mp-dn/curl/install-sh
